...
namespace VantagePro2 {
    /// <summary>
    /// Class for getting the text for the forecast rule value.
    /// </summary>
    public class ForecastRule {
        /// <summary>
        /// The array containing the forecast rules
        /// </summary>
        ...
        private int rule = 193;
        public int Rule {
            get { return rule; }
        }
        public ForecastRule(int rule) {
            this.rule = rule;
        }

        /// <summary>
        /// Get the string for the specified forecast rule
        /// </summary>
        /// <param name="rule">The forecast rule number</param>
        /// <returns>The forecast rule string</returns>
        public static String forecastString(int rule) {
            if (rule >= FORECAST.Length)
                return "";
            else
