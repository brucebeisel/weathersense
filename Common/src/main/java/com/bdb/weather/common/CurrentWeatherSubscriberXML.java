 ...
 * @author Bruce
 */
public class CurrentWeatherSubscriberXML implements Runnable {
    /**
    ...
    public interface CurrentWeatherHandler {
         ...
         */
        void handleCurrentWeather(CurrentWeatherXML cw);
    }
    ...
    private static final Logger logger = Logger.getLogger(CurrentWeatherSubscriberXML.class.getName());
     ...
     */
    public static CurrentWeatherSubscriberXML createSubscriber(CurrentWeatherHandler handler) {
        try {
            CurrentWeatherSubscriberXML subscriber = new CurrentWeatherSubscriberXML(handler);
            subscriber.init();
            return subscriber;
        }
     ...
     */
    private CurrentWeatherSubscriberXML(CurrentWeatherHandler handler) throws IOException, JAXBException {
        ...
        jaxbContext = JAXBContext.newInstance(com.bdb.weather.common.CurrentWeatherXML.class,
                                              LeafWetness.class,
                                              SoilMoisture.class);
    ...
    public void run() {
        ...
        while (!exit) {
            try {
                ...
                if (msg instanceof CurrentWeatherXML) {
                    CurrentWeatherXML cw = (CurrentWeatherXML)msg;
