...
DROP SCHEMA IF EXISTS `weathersense21` ;
CREATE SCHEMA IF NOT EXISTS `weathersense21` ;
USE `weathersense21` ;

-- -----------------------------------------------------
-- Table `weathersense21`.`daily_records`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `weathersense21`.`daily_records` (
...
-- -----------------------------------------------------
-- Table `weathersense21`.`daily_seasonal_averages`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `weathersense21`.`daily_seasonal_averages` (
  `month` INT(2) NOT NULL,
  `day` INT(2) NOT NULL,
...
-- -----------------------------------------------------
-- Table `weathersense21`.`daily_summary`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `weathersense21`.`daily_summary` (
  `date` DATE NOT NULL,
...
-- -----------------------------------------------------
-- Table `weathersense21`.`doppler_radar_images`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `weathersense21`.`doppler_radar_images` (
...
-- -----------------------------------------------------
-- Table `weathersense21`.`history`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `weathersense21`.`history` (
...
-- -----------------------------------------------------
-- Table `weathersense21`.`rain_hour`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `weathersense21`.`rain_hour` (
  `date` DATE NOT NULL,
  ...
  CONSTRAINT `fk_rain_hour_daily_summary`
    FOREIGN KEY (`date`)
    REFERENCES `weathersense21`.`daily_summary` (`date`)
    ON DELETE CASCADE
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `weathersense21`.`rainfall_records`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `weathersense21`.`rainfall_records` (
  `date` DATE NOT NULL,
...
-- -----------------------------------------------------
-- Table `weathersense21`.`temperature_bins`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `weathersense21`.`temperature_bins` (
...
-- -----------------------------------------------------
-- Table `weathersense21`.`temperature_bin_durations`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `weathersense21`.`temperature_bin_durations` (
  `date` DATE NOT NULL,
...
-- -----------------------------------------------------
-- Table `weathersense21`.`temperature_records`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `weathersense21`.`temperature_records` (
  `date` DATE NOT NULL,
...
-- -----------------------------------------------------
-- Table `weathersense21`.`weather_station`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `weathersense21`.`weather_station` (
...
-- -----------------------------------------------------
-- Table `weathersense21`.`wind_slices`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `weathersense21`.`wind_slices` (
  `date` DATE NOT NULL,
...
-- -----------------------------------------------------
-- Table `weathersense21`.`wind_speed_bin_durations`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `weathersense21`.`wind_speed_bin_durations` (
  `date` DATE NOT NULL,
  `heading` DECIMAL(4,1) NOT NULL,
  ...
  CONSTRAINT `fk_wind_slice_wind_speed_bin_duration`
    ...
    REFERENCES `weathersense21`.`wind_slices` (`date` , `heading`)
    ON DELETE CASCADE
    ON UPDATE RESTRICT)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `weathersense21`.`monthly_seasonal_averages`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `weathersense21`.`monthly_seasonal_averages` (
  `month` INT(2) NOT NULL,
...
-- -----------------------------------------------------
-- Table `weathersense21`.`storms`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `weathersense21`.`storms` (
...
-- -----------------------------------------------------
-- Table `weathersense21`.`sensors`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `weathersense21`.`sensors` (
...
-- -----------------------------------------------------
-- Table `weathersense21`.`sensor_value_history`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `weathersense21`.`sensor_value_history` (
  `date` DATETIME NOT NULL,
  ...
  CONSTRAINT `fk_sensor_value_history`
    FOREIGN KEY (`date`)
    REFERENCES `weathersense21`.`history` (`date`)
    ON DELETE CASCADE
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_sensor_value_history_sensors`
    FOREIGN KEY (`sensor_id`)
    REFERENCES `weathersense21`.`sensors` (`sensor_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `weathersense21`.`sensor_stations`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `weathersense21`.`sensor_stations` (
...
-- -----------------------------------------------------
-- Table `weathersense21`.`storm_doppler_images`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `weathersense21`.`storm_doppler_images` (
  ...
  CONSTRAINT `fk_storm_doppler_images_storms`
    ...
    REFERENCES `weathersense21`.`storms` (`start_time`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `weathersense21`.`collector_commands`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `weathersense21`.`collector_commands` (
...
-- -----------------------------------------------------
-- Table `weathersense21`.`sensor_value_summary`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `weathersense21`.`sensor_value_summary` (
  `date` DATE NOT NULL,
  `sensor_id` INT(2) NOT NULL,
...
-- -----------------------------------------------------
-- Table `weathersense21`.`sensor_station_status`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `weathersense21`.`sensor_station_status` (
  ...
  CONSTRAINT `fk_sensor_station_status_sensor_stations1`
    ...
    REFERENCES `weathersense21`.`sensor_stations` (`sensor_station_id`)
    ON DELETE CASCADE
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `weathersense21`.`weather_station_parameters`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `weathersense21`.`weather_station_parameters` (
